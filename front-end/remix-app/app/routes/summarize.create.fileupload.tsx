...
export default function fileUpload() {
  ...
  return (
    <div className="flex flex-col rounded-lg p-3 items-start h-fit">
      ...
      <input disabled={isUploading} ref={inputRef} type="file" id="document" name="document" accept="application/pdf, text/plain, image/png, image/jpeg, audio/mpeg" className="mt-2 text-sm text-grey-500 text-pretty
