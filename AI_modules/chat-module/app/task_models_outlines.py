...
class QuestionGenerator:
  ...
  def generate_mcq(self, topic):
    try:
      ...
      generator = generate.json(self.llm, MCQ)
      result = generator(
          """Create assignment questions in multiple choice question (MCQ) format with 4 options for each question. Provide the question, options, and correct answer.
Create questions related to this topic: {topic}
...
<content>{context}</content>"""
  ...
  def generate_saq(self, topic):
    try:
      ...
      generator = generate.json(self.llm, SAQ)
      result = generator(
          """Create assignment questions in short answer question (SAQ) format. Provide the question and correct answer.
Create questions related to this topic: {topic}
Refer to the following content:
